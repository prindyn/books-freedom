...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var user = {
      email: (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__.ref)('').value,
      password: (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__.ref)('').value
    };
    var socialLink = [{
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_2__.mdiFacebook,
      color: '#4267b2',
      colorInDark: '#4267b2'
    }, {
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_2__.mdiTwitter,
      color: '#1da1f2',
      colorInDark: '#1da1f2'
    }, {
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_2__.mdiGithub,
      color: '#272727',
      colorInDark: '#fff'
    }, {
      icon: _mdi_js__WEBPACK_IMPORTED_MODULE_2__.mdiGoogle,
      color: '#db4437',
      colorInDark: '#db4437'
    }];
    return {
