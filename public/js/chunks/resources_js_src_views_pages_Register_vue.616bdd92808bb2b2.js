...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var user = {
      name: (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__.ref)('').value,
      email: (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__.ref)('').value,
      password: (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__.ref)('').value,
      privacy: (0,_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__.ref)('').value
    };
    var socialLink = [{
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("v-checkbox", {
                        ...
                        model: {
                          value: _vm.user.privacy,
                          callback: function ($$v) {
                            _vm.$set(_vm.user, "privacy", $$v)
                          },
                          expression: "user.privacy",
                        },
                      }),
                      _vm._v(" "),
                      _c(
